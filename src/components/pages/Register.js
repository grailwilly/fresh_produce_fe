    ...
    <>
          ...
          <div className="xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center">
            <div className="bg-white shadow-lg rounded xl:w-1/3 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
              ...
              <div className="mt-6 w-full">
                ...
                <input  onChange={onChangeHandler} id="first_name" name='first_name' aria-labelledby="lName" type="text" className="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2" placeholder="" />
              </div>
              <div className="mt-6 w-full">
                <label htmlFor="lName" className="text-sm font-medium leading-none text-gray-800">
                  {" "}
                ...
                <input  onChange={onChangeHandler} id="last_name" name='last_name' aria-labelledby="lName" type="text" className="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2" placeholder="" />
              </div>
              <div className="mt-6 w-full">
            ...
            <div className="relative flex items-center justify-center">
              <input onChange={onChangeHandler} name='password_confirmation' type={showpass ? "text" : "password"} className="bg-gray-200 border rounded text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
              <div onClick={()=>setShowPass(!showpass)} className="absolute right-0 mt-2 mr-3 cursor-pointer">
                <div id="show">
                  <svg width={16} height={16} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
        ...
        <div className="xl:w-1/3 md:w-1/2 lg:ml-16 ml-8 md:mt-0 mt-6">
          <div className="pl-8 md:block hidden">
            <h1 className="ml-2 text-xl font-bold tracking-wide text-gray-900 uppercase">Discover Farmers' Fine Produce</h1>            
          </div>
          <div className="mb-8 flex items-start mt-8">
            <div>
            ...
            <p className="sm:text-2xl text-xl leading-7 text-gray-600 pl-2.5">The one-stop-shop for all your fresh fruit, vegetables and grocery needs. We deliver joy in a box - from the farm to your table!</p>
          </div>
          <div className="pl-8 md:block hidden">
            <h1 className="ml-2 text-xl font-bold tracking-wide text-gray-900 uppercase">Trust us with your harvest</h1>            
          </div>
          <div className="flex items-start mt-8">
            ...
            <p className="sm:text-2xl text-xl leading-7 text-gray-600 pl-2.5">We eliminate intermediaries by taking control of the Supply Chain by using technology and analytics.</p>
          </div>
        </div>
      </div>
    </div>
