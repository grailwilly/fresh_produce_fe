        ...
        <>
            <li className="font-sans block mt-4 lg:inline-block lg:mt-0 lg:ml-6 align-middle text-black hover:text-dark-green">
                <a href="#" role="button" className="relative flex">
                    ...
                    <span className="absolute right-0 top-0 rounded-full bg-teal w-4 h-4 top right p-0 m-0 text-white font-mono text-sm  leading-tight text-center">{cart.length}
                    </span>
                </a>
            </li>
        </>
